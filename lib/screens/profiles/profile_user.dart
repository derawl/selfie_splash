...
import 'non_mutual_social_circle.dart';
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  Text('User', style: kOnboardTextSmall.copyWith(fontSize: 15),)
                                ],
                              )
                            ],
                          )
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: SizedBox(
                          width: double.infinity,
                          child: ElevatedButton(
                            onPressed: (){showDialog(context: context, builder: FollowModal);},
